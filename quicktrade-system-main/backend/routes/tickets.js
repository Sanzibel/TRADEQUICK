...
router.post("/:ticketCode/payment-request", ticketController.requestPayment);
router.post("/:ticketCode/payment-receipt", ticketController.submitPaymentReceipt);
router.post("/:ticketCode/payment-complete", ticketController.completePayment);
